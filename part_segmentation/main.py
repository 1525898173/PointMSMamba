...
def parse_args():
    ...
    parser.add_argument('--root', type=str, default='/root/autodl-tmp/shapenetcore_partanno_segmentation_benchmark_v0_normal',
                        help='data root')
...
def main(args):
    ...
    exp_dir.mkdir(exist_ok=True)
    checkpoints_dir = exp_dir.joinpath('checkpoint/')
