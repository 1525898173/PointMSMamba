...
class PartNormalDataset(Dataset):
    def __init__(self, root='/root/autodl-tmp/shapenetcore_partanno_segmentation_benchmark_v0_normal', npoints=2500, split='train', class_choice=None, normal_channel=False):
